...
<div class="flex items-center gap-4 mb-8">
    ...
    <h1 class="text-2xl font-bold">Editar pregunta frecuente</h1>
</div>
    ...
    <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <textarea name="answer" rows="4"
                class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-purple-500">{{ old('answer', $faq->answer) }}</textarea>
